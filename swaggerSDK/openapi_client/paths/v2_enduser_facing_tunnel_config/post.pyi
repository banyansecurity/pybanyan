                        ...
                        class access_tiers(
                            ...
                            class MetaOapg:
                                ...
                                class items(
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "site_name", "cname", "dns_search_domains", "udp_port_number", "tunnel_ip_address", "cidrs", "wireguard_public_key", "keepalive", "domains", "dns_enabled", "tunnel_peer_type", ], str]):
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "site_name", "cname", "dns_search_domains", "udp_port_number", "tunnel_ip_address", "cidrs", "wireguard_public_key", "keepalive", "domains", "dns_enabled", "tunnel_peer_type", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v2_enduser_facing_tunnel_config_post_oapg(
        self: api_client.Api,
...
class V2EnduserFacingTunnelConfigPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_enduser_facing_tunnel_config_post(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v2_enduser_facing_tunnel_config_post_oapg(
