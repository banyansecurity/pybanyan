...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'service_tunnel_id': typing.Union[ServiceTunnelIdSchema, str, ],
    },
    total=False
)
...
request_query_service_tunnel_id = api_client.QueryParameter(
    name="service_tunnel_id",
    style=api_client.ParameterStyle.FORM,
    schema=ServiceTunnelIdSchema,
    explode=True,
)
# header params
