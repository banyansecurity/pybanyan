    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                                ...
                                class items(
                                    ...
                                    class MetaOapg:
                                        ...
                                        class properties:
                                            ...
                                            metadata_tag = schemas.StrSchema
                                            metadata_value = schemas.StrSchema
                                    ...
                                    @typing.overload
                                    def __getitem__(self, name: typing_extensions.Literal["metadata_tag"]) -> MetaOapg.properties.metadata_tag: ...
                                    
                                    @typing.overload
                                    def __getitem__(self, name: typing_extensions.Literal["metadata_value"]) -> MetaOapg.properties.metadata_value: ...
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["service_id", "metadata_tag", "metadata_value", "created_at", "updated_at", ], str]):
                                    ...
                                    @typing.overload
                                    def get_item_oapg(self, name: typing_extensions.Literal["metadata_tag"]) -> typing.Union[MetaOapg.properties.metadata_tag, schemas.Unset]: ...
                                    
                                    @typing.overload
                                    def get_item_oapg(self, name: typing_extensions.Literal["metadata_value"]) -> typing.Union[MetaOapg.properties.metadata_value, schemas.Unset]: ...
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["service_id", "metadata_tag", "metadata_value", "created_at", "updated_at", ], str]):
                                    ...
                                    def __new__(
                                        ...
                                        *args: typing.Union[dict, frozendict.frozendict, ],
                                        ...
                                        metadata_tag: typing.Union[MetaOapg.properties.metadata_tag, str, schemas.Unset] = schemas.unset,
                                        metadata_value: typing.Union[MetaOapg.properties.metadata_value, str, schemas.Unset] = schemas.unset,
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["service_metadata"]) -> MetaOapg.properties.service_metadata: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["service_metadata", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["service_metadata"]) -> typing.Union[MetaOapg.properties.service_metadata, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["service_metadata", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    service_metadata: typing.Union[MetaOapg.properties.service_metadata, list, tuple, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> 'data':
                    return super().__new__(
...
class BaseApi(api_client.Api):
    ...
    def _v2_service_metadata_service_id_get_oapg(
        self: api_client.Api,
...
class V2ServiceMetadataServiceIdGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_service_metadata_service_id_get(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v2_service_metadata_service_id_get_oapg(
