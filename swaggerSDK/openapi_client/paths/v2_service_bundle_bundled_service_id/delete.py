...
class BaseApi(api_client.Api):
    ...
    def _v2_service_bundle_bundled_service_id_delete_oapg(
        self: api_client.Api,
...
class V2ServiceBundleBundledServiceIdDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_service_bundle_bundled_service_id_delete(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v2_service_bundle_bundled_service_id_delete_oapg(
