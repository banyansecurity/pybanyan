...
class BaseApi(api_client.Api):
    ...
    def _v2_auth_user_metadata_delete_oapg(
        self: api_client.Api,
...
class V2AuthUserMetadataDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_auth_user_metadata_delete(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, list, tuple, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_auth_user_metadata_delete_oapg(
            body=body,
