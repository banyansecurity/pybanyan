...
class SchemaForRequestBodyApplicationJson(
            ...
            class signals(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "signal_min_threshold", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "signal_min_threshold", ], str]):
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["base_url"]) -> MetaOapg.properties.base_url: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "id", "secret", "signals", "target_platforms", "base_url", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["base_url"]) -> typing.Union[MetaOapg.properties.base_url, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "id", "secret", "signals", "target_platforms", "base_url", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        base_url: typing.Union[MetaOapg.properties.base_url, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    class items(
                                ...
                                class signals(
                                    ...
                                    class MetaOapg:
                                        ...
                                        class items(
                                            ...
                                            def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "integration_id", "name", "type", "signal_min_threshold", "signal_value_match", "signal_not_satisfied_message", "signal_not_satisfied_trustlevel", "created_at", "updated_at", ], str]):
                                                # dict_instance[name] accessor
                                                return super().__getitem__(name)
                                            ...
                                            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "integration_id", "name", "type", "signal_min_threshold", "signal_value_match", "signal_not_satisfied_message", "signal_not_satisfied_trustlevel", "created_at", "updated_at", ], str]):
                                                return super().get_item_oapg(name)
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "type", "active", "api_endpoint", "authentication_type", "authentication_endpoint", "username", "password", "api_key", "description", "created_by", "last_updated_by", "integration_partner", "created_at", "updated_at", "signals", "device_identity_commands", "target_platforms", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_integration_crowdstrike_post_oapg(
        self: api_client.Api,
...
class V2IntegrationCrowdstrikePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_integration_crowdstrike_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_integration_crowdstrike_post_oapg(
            body=body,
