...
# header params
Model1AuthorizationSchema = schemas.StrSchema
...
RequestOptionalHeaderParams = typing_extensions.TypedDict(
    ...
    {
        '1. Authorization': typing.Union[Model1AuthorizationSchema, str, ],
    },
    total=False
)
...
request_header__1__authorization = api_client.HeaderParameter(
    name="1. Authorization",
    style=api_client.ParameterStyle.SIMPLE,
    schema=Model1AuthorizationSchema,
)
# body param
...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["csr", "serialnumber", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["csr", "serialnumber", ], str]):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_cert", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_cert", ], str]):
                    return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_enduser_facing_client_cert_issue_post_oapg(
        self: api_client.Api,
        ...
        for parameter in (
            request_header__1__authorization,
        ):
...
class V2EnduserFacingClientCertIssuePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_enduser_facing_client_cert_issue_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_enduser_facing_client_cert_issue_post_oapg(
            body=body,
