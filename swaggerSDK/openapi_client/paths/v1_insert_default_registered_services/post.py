...
class BaseApi(api_client.Api):
    ...
    def _v1_insert_default_registered_services_post_oapg(
        self: api_client.Api,
...
class V1InsertDefaultRegisteredServicesPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_insert_default_registered_services_post(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_insert_default_registered_services_post_oapg(
