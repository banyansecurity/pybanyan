...
class BaseApi(api_client.Api):
    ...
    def _unregistered_device_endusers_stats_get_oapg(
        self: api_client.Api,
...
class UnregisteredDeviceEndusersStatsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def unregistered_device_endusers_stats_get(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._unregistered_device_endusers_stats_get_oapg(
