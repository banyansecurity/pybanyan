...
class BaseApi(api_client.Api):
    ...
    def _v2_deploy_config_otp_skip_eligible_role_get_oapg(
        self: api_client.Api,
...
class V2DeployConfigOtpSkipEligibleRoleGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_deploy_config_otp_skip_eligible_role_get(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v2_deploy_config_otp_skip_eligible_role_get_oapg(
