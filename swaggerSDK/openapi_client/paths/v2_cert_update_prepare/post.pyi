...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["org_id", "cert_update_code", "serial_number", "principal_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["org_id", "cert_update_code", "serial_number", "principal_name", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v2_cert_update_prepare_post_oapg(
        self: api_client.Api,
...
class V2CertUpdatePreparePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_cert_update_prepare_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_cert_update_prepare_post_oapg(
            body=body,
