...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            captcha_token_response = schemas.StrSchema
            __annotations__ = {
                ...
                "org_name": org_name,
                "campaign": campaign,
                "captcha_token_response": captcha_token_response,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["captcha_token_response"]) -> MetaOapg.properties.captcha_token_response: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["first_name", "last_name", "email", "org_name", "campaign", "captcha_token_response", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["captcha_token_response"]) -> typing.Union[MetaOapg.properties.captcha_token_response, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["first_name", "last_name", "email", "org_name", "campaign", "captcha_token_response", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        captcha_token_response: typing.Union[MetaOapg.properties.captcha_token_response, str, schemas.Unset] = schemas.unset,
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        sender_email = schemas.StrSchema
                        __annotations__ = {
                            "sender_email": sender_email,
                        }
                
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["sender_email"]) -> MetaOapg.properties.sender_email: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["sender_email", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["sender_email"]) -> typing.Union[MetaOapg.properties.sender_email, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sender_email", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    sender_email: typing.Union[MetaOapg.properties.sender_email, str, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> 'data':
                    return super().__new__(
...
class V2SignupPost(BaseApi):
    ...
    def v2_signup_post(
        ...
        return self._v2_signup_post_oapg(
            body=body,
