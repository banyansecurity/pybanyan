...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["resource_id", "resource_name", "resource_type", "parent_id", "public_dns_name", "private_dns_name", "public_ip", "private_ip", "region", "ports", "account", "status", "cloud_provider", "tags", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resource_id", "resource_name", "resource_type", "parent_id", "public_dns_name", "private_dns_name", "public_ip", "private_ip", "region", "ports", "account", "status", "cloud_provider", "tags", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_cloud_resource_post_oapg(
        self: api_client.Api,
...
class V2CloudResourcePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_cloud_resource_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_cloud_resource_post_oapg(
            body=body,
