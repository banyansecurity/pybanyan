...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            signup_verification_key = schemas.StrSchema
            component_names = schemas.StrSchema
            __annotations__ = {
                "signup_verification_key": signup_verification_key,
                "component_names": component_names,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["signup_verification_key"]) -> MetaOapg.properties.signup_verification_key: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["component_names"]) -> MetaOapg.properties.component_names: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["signup_verification_key", "component_names", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["signup_verification_key"]) -> typing.Union[MetaOapg.properties.signup_verification_key, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["component_names"]) -> typing.Union[MetaOapg.properties.component_names, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["signup_verification_key", "component_names", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        signup_verification_key: typing.Union[MetaOapg.properties.signup_verification_key, str, schemas.Unset] = schemas.unset,
        component_names: typing.Union[MetaOapg.properties.component_names, str, schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    ...
    def _v2_signup_provision_org_retry_post_oapg(
        self: api_client.Api,
...
class V2SignupProvisionOrgRetryPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_signup_provision_org_retry_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_signup_provision_org_retry_post_oapg(
            body=body,
