    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["base", "logging", "events", "hosted_web_services", "infrastructure_services", "denial_of_service_protection", "miscellaneous", "debugging", "spec", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["base", "logging", "events", "hosted_web_services", "infrastructure_services", "denial_of_service_protection", "miscellaneous", "debugging", "spec", ], str]):
                    return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_access_tier_facing_access_tier_name_config_get_oapg(
        self: api_client.Api,
...
class V2AccessTierFacingAccessTierNameConfigGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_access_tier_facing_access_tier_name_config_get(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v2_access_tier_facing_access_tier_name_config_get_oapg(
