...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'redirect url': typing.Union[RedirectUrlSchema, str, ],
    }
)
...
request_query_redirect_url = api_client.QueryParameter(
    name="redirect url",
...
class BaseApi(api_client.Api):
    ...
    def _v1_insert_pwless_config_post_oapg(
        self: api_client.Api,
...
class V1InsertPwlessConfigPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_insert_pwless_config_post(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v1_insert_pwless_config_post_oapg(
