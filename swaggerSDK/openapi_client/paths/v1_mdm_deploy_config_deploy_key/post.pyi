...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["mdm_deploy_key", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["mdm_deploy_key", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v1_mdm_deploy_config_deploy_key_post_oapg(
        self: api_client.Api,
...
class V1MdmDeployConfigDeployKeyPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_mdm_deploy_config_deploy_key_post(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_mdm_deploy_config_deploy_key_post_oapg(
