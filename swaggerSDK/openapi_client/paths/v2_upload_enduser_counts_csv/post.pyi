...
class SchemaFor401ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["error_code", "message", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["error_code", "message", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_upload_enduser_counts_csv_post_oapg(
        self: api_client.Api,
...
class V2UploadEnduserCountsCsvPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_upload_enduser_counts_csv_post(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v2_upload_enduser_counts_csv_post_oapg(
