...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'domain name': typing.Union[DomainNameSchema, str, ],
...
RequestOptionalHeaderParams = typing_extensions.TypedDict(
    ...
    {
        'X-Auth-Key': typing.Union[XAuthKeySchema, str, ],
    },
    total=False
)
...
request_header_x_auth_key = api_client.HeaderParameter(
    name="X-Auth-Key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=XAuthKeySchema,
)
_auth = [
    'bearerAuthToken',
]
