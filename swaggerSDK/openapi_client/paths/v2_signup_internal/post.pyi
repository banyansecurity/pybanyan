...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["first_name", "last_name", "email", "org_name", "campaign", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["first_name", "last_name", "email", "org_name", "campaign", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v2_signup_internal_post_oapg(
        self: api_client.Api,
...
class V2SignupInternalPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_signup_internal_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        content_type: str = 'application/json',
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v2_signup_internal_post_oapg(
            body=body,
