            ...
            class factor_settings(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["type1"]) -> MetaOapg.properties.type1: ...
                        
                        @typing.overload
                        def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                        
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "display_name", "description", "enabled", "remediation", "source", "type1", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["type1"]) -> typing.Union[MetaOapg.properties.type1, schemas.Unset]: ...
                        
                        @typing.overload
                        def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                        
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "display_name", "description", "enabled", "remediation", "source", "type1", ], str]):
                            return super().get_item_oapg(name)
                        ...
                        def __new__(
                            ...
                            *args: typing.Union[dict, frozendict.frozendict, ],
                            ...
                            type1: typing.Union[MetaOapg.properties.type1, str, schemas.Unset] = schemas.unset,
                            _configuration: typing.Optional[schemas.Configuration] = None,
                            **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                        ) -> 'items':
                            return super().__new__(
...
class BaseApi(api_client.Api):
    ...
    def _v1_trustscore_config_device_trustscore_factors_get_oapg(
        self: api_client.Api,
...
class V1TrustscoreConfigDeviceTrustscoreFactorsGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_trustscore_config_device_trustscore_factors_get(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_trustscore_config_device_trustscore_factors_get_oapg(
