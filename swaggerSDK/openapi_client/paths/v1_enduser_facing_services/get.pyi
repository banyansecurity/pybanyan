...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["ServiceID", "FriendlyName", "ServiceType", "Metadata", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ServiceID", "FriendlyName", "ServiceType", "Metadata", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v1_enduser_facing_services_get_oapg(
        self: api_client.Api,
...
class V1EnduserFacingServicesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_enduser_facing_services_get(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_enduser_facing_services_get_oapg(
