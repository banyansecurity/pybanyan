...
class BaseApi(api_client.Api):
    ...
    def _v2_integration_device_identity_command_get_oapg(
        self: api_client.Api,
...
class V2IntegrationDeviceIdentityCommandGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_integration_device_identity_command_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v2_integration_device_identity_command_get_oapg(
