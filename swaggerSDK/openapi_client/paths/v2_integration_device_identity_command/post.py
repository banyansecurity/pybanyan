...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["integration_id", "platform", "version", "command", "utility_signature_data", "utility_signature_command", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["integration_id", "platform", "version", "command", "utility_signature_data", "utility_signature_command", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v2_integration_device_identity_command_post_oapg(
        self: api_client.Api,
...
class V2IntegrationDeviceIdentityCommandPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_integration_device_identity_command_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_integration_device_identity_command_post_oapg(
            body=body,
