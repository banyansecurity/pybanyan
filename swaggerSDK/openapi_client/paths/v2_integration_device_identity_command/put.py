...
class BaseApi(api_client.Api):
    ...
    def _v2_integration_device_identity_command_put_oapg(
        self: api_client.Api,
...
class V2IntegrationDeviceIdentityCommandPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_integration_device_identity_command_put(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_integration_device_identity_command_put_oapg(
            body=body,
