...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["groupName", "userName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["groupName", "userName", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v1_banyanidp_admin_user_group_delete_oapg(
        self: api_client.Api,
...
class V1BanyanidpAdminUserGroupDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_banyanidp_admin_user_group_delete(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v1_banyanidp_admin_user_group_delete_oapg(
            body=body,
