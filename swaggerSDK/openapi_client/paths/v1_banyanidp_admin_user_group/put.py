...
class SchemaForRequestBodyApplicationJson(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["groupNames"]) -> MetaOapg.properties.groupNames: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["groupNames", "email", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["groupNames"]) -> typing.Union[MetaOapg.properties.groupNames, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["groupNames", "email", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        groupNames: typing.Union[MetaOapg.properties.groupNames, str, schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    ...
    def _v1_banyanidp_admin_user_group_put_oapg(
        self: api_client.Api,
...
class V1BanyanidpAdminUserGroupPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_banyanidp_admin_user_group_put(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v1_banyanidp_admin_user_group_put_oapg(
            body=body,
