...
class BaseApi(api_client.Api):
    ...
    def _v1_banyanidp_enduser_resendconfirmationcode_post_oapg(
        self: api_client.Api,
...
class V1BanyanidpEnduserResendconfirmationcodePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_banyanidp_enduser_resendconfirmationcode_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        content_type: str = 'application/json',
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v1_banyanidp_enduser_resendconfirmationcode_post_oapg(
            body=body,
