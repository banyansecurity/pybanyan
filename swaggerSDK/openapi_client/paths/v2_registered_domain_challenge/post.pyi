...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            registered_domain_name = schemas.StrSchema
            __annotations__ = {
                "registered_domain_name": registered_domain_name,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["registered_domain_name"]) -> MetaOapg.properties.registered_domain_name: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["registered_domain_name", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["registered_domain_name"]) -> typing.Union[MetaOapg.properties.registered_domain_name, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["registered_domain_name", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        registered_domain_name: typing.Union[MetaOapg.properties.registered_domain_name, str, schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    ...
    def _v2_registered_domain_challenge_post_oapg(
        self: api_client.Api,
...
class V2RegisteredDomainChallengePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_registered_domain_challenge_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_registered_domain_challenge_post_oapg(
            body=body,
