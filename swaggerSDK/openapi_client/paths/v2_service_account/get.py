...
NameLikeSchema = schemas.StrSchema
ApiKeySchema = schemas.StrSchema
ServiceAccountTypeSchema = schemas.StrSchema
OidcTokenTypeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'name_like': typing.Union[NameLikeSchema, str, ],
        'api_key': typing.Union[ApiKeySchema, str, ],
        'service_account_type': typing.Union[ServiceAccountTypeSchema, str, ],
        'oidc_token_type': typing.Union[OidcTokenTypeSchema, str, ],
...
request_query_name_like = api_client.QueryParameter(
    name="name_like",
    style=api_client.ParameterStyle.FORM,
    schema=NameLikeSchema,
    explode=True,
)
...
request_query_service_account_type = api_client.QueryParameter(
    name="service_account_type",
    style=api_client.ParameterStyle.FORM,
    schema=ServiceAccountTypeSchema,
    explode=True,
)
request_query_oidc_token_type = api_client.QueryParameter(
    name="oidc_token_type",
    style=api_client.ParameterStyle.FORM,
    schema=OidcTokenTypeSchema,
    explode=True,
)
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                                ...
                                class items(
                                    ...
                                    class MetaOapg:
                                        ...
                                        class properties:
                                            ...
                                            last_authorized_at = schemas.IntSchema
                                    ...
                                    @typing.overload
                                    def __getitem__(self, name: typing_extensions.Literal["last_authorized_at"]) -> MetaOapg.properties.last_authorized_at: ...
                                    ...
                                    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "description", "created_at", "updated_at", "last_authorized_at", "updated_by", "service_account_type", "api_key", "roles", ], str]):
                                    ...
                                    @typing.overload
                                    def get_item_oapg(self, name: typing_extensions.Literal["last_authorized_at"]) -> typing.Union[MetaOapg.properties.last_authorized_at, schemas.Unset]: ...
                                    ...
                                    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "description", "created_at", "updated_at", "last_authorized_at", "updated_by", "service_account_type", "api_key", "roles", ], str]):
                                    ...
                                    def __new__(
                                        ...
                                        *args: typing.Union[dict, frozendict.frozendict, ],
                                        ...
                                        last_authorized_at: typing.Union[MetaOapg.properties.last_authorized_at, decimal.Decimal, int, schemas.Unset] = schemas.unset,
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["service_accounts"]) -> MetaOapg.properties.service_accounts: ...
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["service_accounts", "count", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["service_accounts"]) -> typing.Union[MetaOapg.properties.service_accounts, schemas.Unset]: ...
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["service_accounts", "count", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    cls,
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    service_accounts: typing.Union[MetaOapg.properties.service_accounts, list, tuple, schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    ...
    def _v2_service_account_get_oapg(
        self: api_client.Api,
        ...
        for parameter in (
            request_query_id,
            request_query_name,
            request_query_name_like,
            request_query_api_key,
            request_query_service_account_type,
            request_query_oidc_token_type,
...
class V2ServiceAccountGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_service_account_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v2_service_account_get_oapg(
