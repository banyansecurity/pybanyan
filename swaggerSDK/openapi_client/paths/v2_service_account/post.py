    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "description", "created_at", "updated_at", "updated_by", "service_account_type", "api_key", "roles", "last_login", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "description", "created_at", "updated_at", "updated_by", "service_account_type", "api_key", "roles", "last_login", ], str]):
                    return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_service_account_post_oapg(
        self: api_client.Api,
...
class V2ServiceAccountPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_service_account_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_service_account_post_oapg(
            body=body,
