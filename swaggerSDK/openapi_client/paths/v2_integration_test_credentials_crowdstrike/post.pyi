...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "secret", "base_url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "secret", "base_url", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v2_integration_test_credentials_crowdstrike_post_oapg(
        self: api_client.Api,
...
class V2IntegrationTestCredentialsCrowdstrikePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_integration_test_credentials_crowdstrike_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_integration_test_credentials_crowdstrike_post_oapg(
            body=body,
