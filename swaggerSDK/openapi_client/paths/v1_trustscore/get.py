...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["TrustType", "TrustID", "Score", "Level", "ExtSource", "Reason", "FactorsJSON", "CreatedAt", "DeletedAt", "LastUpdatedAt", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TrustType", "TrustID", "Score", "Level", "ExtSource", "Reason", "FactorsJSON", "CreatedAt", "DeletedAt", "LastUpdatedAt", ], str]):
...
class V1TrustscoreGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_trustscore_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v1_trustscore_get_oapg(
