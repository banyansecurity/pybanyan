...
# query params
InviteCodeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'invite code': typing.Union[InviteCodeSchema, str, ],
    },
    total=False
)
...
request_query_invite_code = api_client.QueryParameter(
    name="invite code",
...
class V1ConfigUrlGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_config_url_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_config_url_get_oapg(
