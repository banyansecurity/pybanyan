            ...
            class device_identity_commands(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "integration_id", "platform", "version", "command", "utility_signature_data", "utility_signature_command", "created_at", "updated_at", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "integration_id", "platform", "version", "command", "utility_signature_data", "utility_signature_command", "created_at", "updated_at", ], str]):
                            return super().get_item_oapg(name)
...
class V2IntegrationGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_integration_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v2_integration_get_oapg(
