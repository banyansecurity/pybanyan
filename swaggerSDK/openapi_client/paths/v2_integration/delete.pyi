...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "type", "active", "api_endpoint", "authentication_type", "authentication_endpoint", "username", "password", "api_key", "description", "created_by", "last_updated_by", "integration_partner", "created_at", "updated_at", "signals", "device_identity_commands", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "org_id", "name", "type", "active", "api_endpoint", "authentication_type", "authentication_endpoint", "username", "password", "api_key", "description", "created_by", "last_updated_by", "integration_partner", "created_at", "updated_at", "signals", "device_identity_commands", ], str]):
        return super().get_item_oapg(name)
...
class BaseApi(api_client.Api):
    ...
    def _v2_integration_delete_oapg(
        self: api_client.Api,
...
class V2IntegrationDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_integration_delete(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v2_integration_delete_oapg(
            body=body,
