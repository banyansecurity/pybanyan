...
ProfileSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'Profile': typing.Union[ProfileSchema, str, ],
    },
    total=False
)
...
request_query_profile = api_client.QueryParameter(
    name="Profile",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    ...
    def _v1_admin_update_user_post_oapg(
        self: api_client.Api,
...
class V1AdminUpdateUserPost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_admin_update_user_post(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_admin_update_user_post_oapg(
