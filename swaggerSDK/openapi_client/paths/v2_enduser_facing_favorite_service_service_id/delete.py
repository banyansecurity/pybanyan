...
class BaseApi(api_client.Api):
    ...
    def _v2_enduser_facing_favorite_service_service_id_delete_oapg(
        self: api_client.Api,
...
class V2EnduserFacingFavoriteServiceServiceIdDelete(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_enduser_facing_favorite_service_service_id_delete(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        ...
        return self._v2_enduser_facing_favorite_service_service_id_delete_oapg(
            body=body,
