        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    class properties:
                        cert_password = schemas.StrSchema
                        __annotations__ = {
                            "cert_password": cert_password,
                        }
                
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["cert_password"]) -> MetaOapg.properties.cert_password: ...
                
                @typing.overload
                def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
                
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["cert_password", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                
                
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["cert_password"]) -> typing.Union[MetaOapg.properties.cert_password, schemas.Unset]: ...
                
                @typing.overload
                def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
                
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cert_password", ], str]):
                ...
                def __new__(
                    ...
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    cert_password: typing.Union[MetaOapg.properties.cert_password, str, schemas.Unset] = schemas.unset,
...
class BaseApi(api_client.Api):
    ...
    def _v2_staged_device_cert_password_get_oapg(
        self: api_client.Api,
...
class V2StagedDeviceCertPasswordGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v2_staged_device_cert_password_get(
        self: BaseApi,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v2_staged_device_cert_password_get_oapg(
