...
RequestOptionalHeaderParams = typing_extensions.TypedDict(
    'RequestOptionalHeaderParams',
    {
        ...
        '3. X-Server-Location': typing.Union[Model3XServerLocationSchema, str, ],
    },
    total=False
)
...
request_header__3__x_server_location = api_client.HeaderParameter(
    name="3. X-Server-Location",
    style=api_client.ParameterStyle.SIMPLE,
    schema=Model3XServerLocationSchema,
)
# body param
