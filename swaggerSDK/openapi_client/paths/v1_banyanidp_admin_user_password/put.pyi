...
class SchemaForRequestBodyApplicationJson(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["permanent"]) -> MetaOapg.properties.permanent: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "password", "permanent", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["permanent"]) -> typing.Union[MetaOapg.properties.permanent, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "password", "permanent", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        permanent: typing.Union[MetaOapg.properties.permanent, bool, schemas.Unset] = schemas.unset,
        ...
        class properties:
            ...
            class data(
                ...
                def __new__(
                    cls,
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    Message: typing.Union[MetaOapg.properties.Message, decimal.Decimal, int, schemas.Unset] = schemas.unset,
                    _configuration: typing.Optional[schemas.Configuration] = None,
                    **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
                ) -> 'data':
                    return super().__new__(
...
class BaseApi(api_client.Api):
    ...
    def _v1_banyanidp_admin_user_password_put_oapg(
        self: api_client.Api,
...
class V1BanyanidpAdminUserPasswordPut(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_banyanidp_admin_user_password_put(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        header_params: RequestHeaderParams = frozendict.frozendict(),
        content_type: str = 'application/json',
        ...
        return self._v1_banyanidp_admin_user_password_put_oapg(
            body=body,
