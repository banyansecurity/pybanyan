...
class SchemaForRequestBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            response_type = schemas.StrSchema
            id_token = schemas.StrSchema
            alternate_response = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["alternate_response"]) -> MetaOapg.properties.alternate_response: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "operation", "response_type", "id_token", "alternate_response", "access_token", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["alternate_response"]) -> typing.Union[MetaOapg.properties.alternate_response, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "operation", "response_type", "id_token", "alternate_response", "access_token", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        alternate_response: typing.Union[MetaOapg.properties.alternate_response, str, schemas.Unset] = schemas.unset,
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            ssh_certificate = schemas.StrSchema
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ssh_certificate"]) -> MetaOapg.properties.ssh_certificate: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["certificate", "ssh_certificate", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ssh_certificate"]) -> typing.Union[MetaOapg.properties.ssh_certificate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["certificate", "ssh_certificate", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ssh_certificate: typing.Union[MetaOapg.properties.ssh_certificate, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
...
class BaseApi(api_client.Api):
    ...
    def _v1_cert_exchange_post_oapg(
        self: api_client.Api,
...
class V1CertExchangePost(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_cert_exchange_post(
        self: BaseApi,
        body: typing.Union[SchemaForRequestBodyApplicationJson, dict, frozendict.frozendict, ],
        content_type: str = 'application/json',
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        ...
        return self._v1_cert_exchange_post_oapg(
            body=body,
