...
# query params
OperationSchema = schemas.StrSchema
MessageSchema = schemas.StrSchema
ResponseTypeSchema = schemas.StrSchema
IDTokenSchema = schemas.StrSchema
ALTERNATERESPONSESchema = schemas.StrSchema
AccessTokenOptionalSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'ResponseType': typing.Union[ResponseTypeSchema, str, ],
        'IDToken': typing.Union[IDTokenSchema, str, ],
        'ALTERNATERESPONSE': typing.Union[ALTERNATERESPONSESchema, str, ],
        'AccessToken (optional)': typing.Union[AccessTokenOptionalSchema, str, ],
    },
    total=False
)
...
request_query_id_token = api_client.QueryParameter(
    name="IDToken",
    style=api_client.ParameterStyle.FORM,
...
request_query_access_token__optional = api_client.QueryParameter(
    name="AccessToken (optional)",
    style=api_client.ParameterStyle.FORM,
    schema=AccessTokenOptionalSchema,
    explode=True,
)
_auth = [
    'bearerAuthToken',
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["root_ca_certs", "intermediate_ca_certs", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["root_ca_certs", "intermediate_ca_certs", ], str]):
...
class BaseApi(api_client.Api):
    ...
    def _v1_cert_exchange_get_oapg(
        self: api_client.Api,
        ...
        for parameter in (
            ...
            request_query_id_token,
            request_query_alternateresponse,
            request_query_access_token__optional,
        ):
...
class V1CertExchangeGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    def v1_cert_exchange_get(
        self: BaseApi,
        query_params: RequestQueryParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
        ...
        return self._v1_cert_exchange_get_oapg(
