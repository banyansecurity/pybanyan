<a name="__pageTop"></a>
# openapi_client.apis.tags.service_connection_test_api.ServiceConnectionTestApi
...
from openapi_client.apis.tags import service_connection_test_api
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = service_connection_test_api.ServiceConnectionTestApi(api_client)
    ...
    try:
        ...
        print("Exception when calling ServiceConnectionTestApi->v1_service_connection_test_post: %s\n" % e)
